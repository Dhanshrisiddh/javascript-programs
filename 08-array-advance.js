...
array.push(40);   //for inserting element at the end of the array
console.log(array);

console.log(`Inserting element at the beginning of the array`);
array.unshift(90);     // for inserting element at the beginning of array 
console.log(array);
...
console.log(`Delete element at the begining of the array`);
arrayNum.shift();
console.log(arrayNum);
